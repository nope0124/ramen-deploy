    ...
    <React.Fragment>
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <Input
              className={classNames("__wab_instance", sty.input__hC3Uu)}
            ...
            <Input
              className={classNames("__wab_instance", sty.input__xY0UB)}
              placeholder={
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__zbs4D)}>
              <Button
...
const PlasmicDescendants = {
  root: ["root", "tabPage", "button"],
  tabPage: ["tabPage", "button"],
  button: ["button"]
} as const;
