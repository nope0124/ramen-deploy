...
function PlasmicStackPage__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__zibpk)}>
        <div
        ...
        >
          <div className={classNames(defaultcss.all, sty.freeBox__icgMe)}>
            <p.Stack
              as={p.PlasmicLink}
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__uLzX)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(defaultcss.all, sty.freeBox__b6G9V)}
                  />
                ),
        ...
        >
          <div className={classNames(defaultcss.all, sty.freeBox__mzAs)}>
            {p.renderPlasmicSlot({
