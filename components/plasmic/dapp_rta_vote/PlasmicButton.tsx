...
export const PlasmicButton__VariantProps = new Array<VariantPropType>("color");
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox___22Ni4)}>
        <div
          className={classNames(defaultcss.all, sty.freeBox__bgnWk, {
            [sty.freeBox__color_offwhite__bgnWkzCsOi]: hasVariant(
              variants,
              "color",
              "offwhite"
            ),
            [sty.freeBox__color_secondary__bgnWKsJ1Fy]: hasVariant(
              variants,
              "color",
              "secondary"
            ),
            [sty.freeBox__color_transparent__bgnWKrMKn]: hasVariant(
              variants,
              "color",
              "transparent"
            )
