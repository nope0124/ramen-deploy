      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__cbJ0Q)}>
              <div className={classNames(defaultcss.all, sty.freeBox___4GXFy)}>
                <Button
...
const PlasmicDescendants = {
  root: ["root", "stackPage", "button"],
  stackPage: ["stackPage", "button"],
  button: ["button"]
} as const;
